    ...
    return <>
        ...
        <div className='flex flex-col justify-center items-start text-xl font-medium ml-16 md:ml-48 lg:ml-80 mt-48 mb-48'>
            <div className='space-y-8 '>{/*  So that items start in same vertical line */}
                ...
                <div>
                    <a href="https://www.linkedin.com/in/shahzad-ahamad-80b36662" className='flex items-center space-x-10'> <div className="bg-teal-500 rounded-full p-5 text-white text-3xl"><FaLinkedin /></div><span className='text-teal-900 hover:underline'>linkedin.com/in/shahzad-ahamad-80b36662</span></a>
                </div>
                <div>
