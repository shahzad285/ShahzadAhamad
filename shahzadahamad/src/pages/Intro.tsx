export default function Intro() {
    return <>
        <div className="flex flex-col lg:flex-row mt-20 md:mt-0 min-h-screen">
            <div className="z-10 text-base md:text-lg  lg:text-xl text-slate-300 flex flex-col bg-transparent justify-center items-start p-8 lg:ml-32 lg:w-1/2">
                <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-4">Hi, I'm Shahzad</h1>
            ...
            <div id="profilePhoto" className="z-0 lg:w-2/3 -mt-48 lg:mt-0">
